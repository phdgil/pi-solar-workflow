...
export async function runFixtureFlow(fixture, client, runtime, workspace, deadline, flow) {
  ...
  if (!new Set(["execute-summary", "execute-inventory-heldout", "execute-fresh-023a-heldout", "execute-fresh-023b-heldout"]).has(fixture.name)) throw new Error("Programmatic confirmation is forbidden outside the explicit synthetic execute allowlist.");
